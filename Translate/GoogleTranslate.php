...
class GoogleTranslate
{
	...
	{
		$httpStatus = $this->curl(array('url' => "http://translate.google.cn"), "", true);
		if (!isset($httpStatus['http_code']) || $httpStatus['http_code'] != 200) {
			return "Please enter link (http://translate.google.cn) ok";
		}
	}
	 ...
	 * @return string
	 */
	public function api($tranInfo = array('tl' => 'en', 'text' => 'Hello World'), $status = false)
	{
	    $langArr = array(
